  ...
  return (
    <nav className={cn(
      ...
      <div className="container flex items-center justify-between">
        <a href="#hero" className="text-sm sm:text-md md:text-xl font-bold text-primary flex items-center">
        ...
        <div className="hidden md:flex space-x-8">
          {navItems.map((item, key) => (
            <a
              ...
              href={item.href}
              className={cn(
                "relative text-foreground/80 hover:text-primary transition-colors duration-300 group",
        ...
        >
          <div className="fixed top-8 left-5 z-50">
            <ThemeToggle />
          </div>
